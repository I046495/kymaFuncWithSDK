...
export interface EntityApi<EntityT extends EntityBase, DeSerializersT extends DeSerializers = DefaultDeSerializers> {
    ...
    customField<NullableT extends boolean>(fieldName: string): CustomField<EntityT, DeSerializersT, NullableT>;
}
/**
 * Helper type to extract the type of an entity from an API so EntityType<MyPetApi<Dog>> is `Dog`.
 */
export type EntityType<forExtraction> = forExtraction extends EntityApi<infer EntityT, any> ? EntityT : never;
