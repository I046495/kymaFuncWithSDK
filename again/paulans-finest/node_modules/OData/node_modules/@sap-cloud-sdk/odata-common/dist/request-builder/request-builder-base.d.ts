...
export declare abstract class MethodRequestBuilder<RequestConfigT extends ODataRequestConfig = any> {
     ...
     */
    url(destination: HttpDestinationOrFetchOptions): Promise<string>;
    /**
    ...
    protected build(destination: HttpDestinationOrFetchOptions): Promise<ODataRequest<RequestConfigT>>;
}
