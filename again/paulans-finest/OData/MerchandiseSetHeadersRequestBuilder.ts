 ...
 */
export class MerchandiseSetHeadersRequestBuilder<
...
> extends RequestBuilder<MerchandiseSetHeaders<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<MerchandiseSetHeaders<T>, T>(
      this.entityApi,
      {
        tenant: tenant,
  ...
  getAll(): GetAllRequestBuilder<MerchandiseSetHeaders<T>, T> {
    return new GetAllRequestBuilder<MerchandiseSetHeaders<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<MerchandiseSetHeaders<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<MerchandiseSetHeaders<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<MerchandiseSetHeaders<T>, T>(
      this.entityApi,
      tenantOrEntity instanceof MerchandiseSetHeaders
        ? tenantOrEntity
        : {
