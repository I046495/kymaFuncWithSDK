...
import type { Destination, DestinationRetrievalOptions } from './destination-service-types';
 ...
 * @internal
 */
export declare function isDestinationFetchOptions(destination: any): destination is DestinationFetchOptions;
/**
