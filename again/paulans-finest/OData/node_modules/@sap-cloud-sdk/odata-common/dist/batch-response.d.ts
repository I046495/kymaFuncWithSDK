 ...
 * @internal
 */
export type BatchResponse<DeSerializersT extends DeSerializers> = ErrorResponse | ReadResponse<DeSerializersT> | WriteResponses<DeSerializersT>;
...
export interface ReadResponse<DeSerializersT extends DeSerializers> extends BatchResponseTypeGuards<DeSerializersT> {
     ...
     */
    as: <EntityT extends EntityBase>(entityApi: EntityApi<EntityT, DeSerializersT>) => EntityT[];
}
/**
