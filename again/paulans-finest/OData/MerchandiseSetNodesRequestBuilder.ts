 ...
 */
export class MerchandiseSetNodesRequestBuilder<
...
> extends RequestBuilder<MerchandiseSetNodes<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<MerchandiseSetNodes<T>, T>(
      this.entityApi,
      {
        tenant: tenant,
  ...
  getAll(): GetAllRequestBuilder<MerchandiseSetNodes<T>, T> {
    return new GetAllRequestBuilder<MerchandiseSetNodes<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<MerchandiseSetNodes<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<MerchandiseSetNodes<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<MerchandiseSetNodes<T>, T>(
      this.entityApi,
      tenantOrEntity instanceof MerchandiseSetNodes
        ? tenantOrEntity
        : {
