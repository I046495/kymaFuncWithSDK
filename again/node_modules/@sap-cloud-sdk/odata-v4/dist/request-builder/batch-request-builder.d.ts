...
import { BatchRequestBuilder } from '@sap-cloud-sdk/odata-common/internal';
 ...
 */
export declare class ODataBatchRequestBuilder<DeSerializersT extends DeSerializers = DefaultDeSerializers> extends BatchRequestBuilder<DeSerializersT> {
    /**
     ...
     */
    execute(destination: HttpDestinationOrFetchOptions): Promise<BatchResponse<DeSerializersT>[]>;
}
