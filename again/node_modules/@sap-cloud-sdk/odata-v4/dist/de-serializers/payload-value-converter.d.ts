 ...
 */
export declare function edmToTs(value: any, edmType: EdmTypeShared<'v4'>, deSerializers: DeSerializers): any;
/**
 * @internal
 */
export declare function tsToEdm(value: any, edmType: EdmTypeShared<'v4'>, deSerializers: DeSerializers): any;
