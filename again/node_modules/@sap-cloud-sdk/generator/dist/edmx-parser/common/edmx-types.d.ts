 ...
 * @internal
 */
export interface EdmxEntityTypeBase<NavigationT> extends EdmxNamed, EdmxNamespaced {
    /**
     * @internal
     */
    Key: EdmxKey;
 ...
 * @internal
 */
export interface JoinedEntityMetadata<EntitySetT extends EdmxEntitySetBase, EntityTypeT extends EdmxEntityTypeBase<any>> {
    /**
     * @internal
     */
