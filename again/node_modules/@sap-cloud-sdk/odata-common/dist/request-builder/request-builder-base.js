...
exports.MethodRequestBuilder = void 0;
...
const odata_request_1 = require("../request/odata-request");
/**
...
class MethodRequestBuilder {
    ...
    middleware(first, ...rest) {
        this.requestConfig.middlewares = (0, util_1.transformVariadicArgumentToArray)(first, rest);
        return this;
    }
    /**
    ...
    build(destination) {
        if (destination) {
            return (0, connectivity_1.useOrFetchDestination)(destination)
                .then(dest => {
                if (!dest) {
                    throw Error((0, internal_1.noDestinationErrorMessage)(destination));
                }
                (0, internal_1.assertHttpDestination)(dest);
                return new odata_request_1.ODataRequest(this.requestConfig, dest);
            })
                .catch(error => {
                throw new util_1.ErrorWithCause((0, internal_1.noDestinationErrorMessage)(destination), error);
            });
        }
