 ...
 * @internal
 */
export declare abstract class GetRequestBuilderBase<EntityT extends EntityBase, DeSerializersT extends DeSerializers, RequestConfigT extends ODataGetAllRequestConfig<EntityT, DeSerializersT> | ODataGetByKeyRequestConfig<EntityT, DeSerializersT>> extends MethodRequestBuilder<RequestConfigT> implements EntityIdentifiable<EntityT, DeSerializersT> {
     ...
     */
    constructor(_entityApi: EntityApi<EntityT, DeSerializersT>, requestConfig: RequestConfigT);
    /**
