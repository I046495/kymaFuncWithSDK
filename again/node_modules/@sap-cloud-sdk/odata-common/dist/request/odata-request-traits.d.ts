 ...
 */
export interface WithSelection<EntityT extends EntityBase, DeSerializersT extends DeSerializers> {
    /**
 ...
 */
export interface WithGetAllRestrictions<EntityT extends EntityBase, DeSerializersT extends DeSerializers> extends WithSelection<EntityT, DeSerializersT> {
    /**
