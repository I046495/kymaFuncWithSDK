 ...
 */
export declare class PromotionTextsRequestBuilder<
...
> extends RequestBuilder<PromotionTexts<T>, T> {
   ...
   */
  create(entity: PromotionTexts<T>): CreateRequestBuilder<PromotionTexts<T>, T>;
  /**
   ...
   */
  update(entity: PromotionTexts<T>): UpdateRequestBuilder<PromotionTexts<T>, T>;
  /**
