 ...
 */
export class PriceDerivationRuleEligibilitiesRequestBuilder<
...
> extends RequestBuilder<PriceDerivationRuleEligibilities<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<PriceDerivationRuleEligibilities<T>, T>(
      this.entityApi,
      {
        tenant: tenant,
        id: id
  ...
  getAll(): GetAllRequestBuilder<PriceDerivationRuleEligibilities<T>, T> {
    return new GetAllRequestBuilder<PriceDerivationRuleEligibilities<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<PriceDerivationRuleEligibilities<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<PriceDerivationRuleEligibilities<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<PriceDerivationRuleEligibilities<T>, T>(
      this.entityApi,
      tenantOrEntity instanceof PriceDerivationRuleEligibilities
        ? tenantOrEntity
        : {
