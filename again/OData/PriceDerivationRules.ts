 ...
 */
export class PriceDerivationRules<
  ...
  implements PriceDerivationRulesType<T>
{
   ...
   */
  static _entityName = 'PriceDerivationRules';
  /**
   ...
   */
  static _keys = ['tenant', 'priceDerivationRuleID'];
  /**
   * Tenant.
   * Maximum length: 36.
   */
  ...
  constructor(readonly _entityApi: PriceDerivationRulesApi<T>) {
    super(_entityApi);
  }
}
