 ...
 */
export class MixAndMatchPriceDerivationItemsRequestBuilder<
...
> extends RequestBuilder<MixAndMatchPriceDerivationItems<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<MixAndMatchPriceDerivationItems<T>, T>(
      this.entityApi,
      {
        tenant: tenant,
  ...
  getAll(): GetAllRequestBuilder<MixAndMatchPriceDerivationItems<T>, T> {
    return new GetAllRequestBuilder<MixAndMatchPriceDerivationItems<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<MixAndMatchPriceDerivationItems<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<MixAndMatchPriceDerivationItems<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<MixAndMatchPriceDerivationItems<T>, T>(
      this.entityApi,
      tenantOrEntity instanceof MixAndMatchPriceDerivationItems
        ? tenantOrEntity
        : {
