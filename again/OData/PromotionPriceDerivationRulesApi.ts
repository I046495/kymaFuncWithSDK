    ...
    EntityApi<PromotionPriceDerivationRules<DeSerializersT>, DeSerializersT>
{
  ...
  private navigationPropertyFields!: {
    ...
    >;
    /**
     * Static representation of the one-to-many navigation property {@link timeRestrictions} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    TIME_RESTRICTIONS: Link<
      PromotionPriceDerivationRules<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      TIME_RESTRICTIONS: new Link('timeRestrictions', this, linkedApis[4])
    };
    return this;
  }
  ...
  private _schema?: {
    ...
    RESOLUTION: OrderableEdmTypeField<
      ...
      true
    >;
    RECURRENT: OrderableEdmTypeField<
      PromotionPriceDerivationRules<DeSerializers>,
      DeSerializersT,
      'Edm.Boolean',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link recurrent} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        RECURRENT: fieldBuilder.buildEdmTypeField(
          'recurrent',
          'Edm.Boolean',
          true
        ),
