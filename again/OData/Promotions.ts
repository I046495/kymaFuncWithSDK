 ...
 */
export class Promotions<T extends DeSerializers = DefaultDeSerializers>
  extends Entity
  implements PromotionsType<T>
{
   ...
   */
  static _keys = ['tenant', 'promotionID'];
  /**
   * Tenant.
   * Maximum length: 36.
   */
  ...
  constructor(readonly _entityApi: PromotionsApi<T>) {
    super(_entityApi);
  }
}
