 ...
 */
export class AddBonusPriceDerivationItemsRequestBuilder<
...
> extends RequestBuilder<AddBonusPriceDerivationItems<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<AddBonusPriceDerivationItems<T>, T>(
      this.entityApi,
      {
        tenant: tenant,
  ...
  getAll(): GetAllRequestBuilder<AddBonusPriceDerivationItems<T>, T> {
    return new GetAllRequestBuilder<AddBonusPriceDerivationItems<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<AddBonusPriceDerivationItems<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<AddBonusPriceDerivationItems<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<AddBonusPriceDerivationItems<T>, T>(
      this.entityApi,
      tenantOrEntity instanceof AddBonusPriceDerivationItems
        ? tenantOrEntity
        : {
