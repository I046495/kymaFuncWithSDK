 ...
 */
export declare class ExternalActionRuleParameters<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements ExternalActionRuleParametersType<T>
{
  readonly _entityApi: ExternalActionRuleParametersApi<T>;
  /**
  ...
  constructor(_entityApi: ExternalActionRuleParametersApi<T>);
}
