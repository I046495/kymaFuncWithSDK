 ...
 */
export declare class PriceDerivationRuleEligibilities<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements PriceDerivationRuleEligibilitiesType<T>
{
  readonly _entityApi: PriceDerivationRuleEligibilitiesApi<T>;
  /**
  ...
  constructor(_entityApi: PriceDerivationRuleEligibilitiesApi<T>);
}
