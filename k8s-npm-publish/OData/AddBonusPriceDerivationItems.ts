 ...
 */
export class AddBonusPriceDerivationItems<
  ...
  implements AddBonusPriceDerivationItemsType<T>
{
   ...
   */
  static _entityName = 'AddBonusPriceDerivationItems';
  /**
  ...
  constructor(readonly _entityApi: AddBonusPriceDerivationItemsApi<T>) {
    super(_entityApi);
  }
}
