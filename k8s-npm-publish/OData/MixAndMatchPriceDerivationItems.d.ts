 ...
 */
export declare class MixAndMatchPriceDerivationItems<
    T extends DeSerializers = DefaultDeSerializers
  >
  extends Entity
  implements MixAndMatchPriceDerivationItemsType<T>
{
  readonly _entityApi: MixAndMatchPriceDerivationItemsApi<T>;
  /**
  ...
  constructor(_entityApi: MixAndMatchPriceDerivationItemsApi<T>);
}
