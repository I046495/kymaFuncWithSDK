 ...
 */
export class PromotionPriceDerivationRulesRequestBuilder<
...
> extends RequestBuilder<PromotionPriceDerivationRules<T>, T> {
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<PromotionPriceDerivationRules<T>, T>(
      this.entityApi,
      {
        tenant: tenant,
  ...
  getAll(): GetAllRequestBuilder<PromotionPriceDerivationRules<T>, T> {
    return new GetAllRequestBuilder<PromotionPriceDerivationRules<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<PromotionPriceDerivationRules<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<PromotionPriceDerivationRules<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<PromotionPriceDerivationRules<T>, T>(
      this.entityApi,
      tenantOrEntity instanceof PromotionPriceDerivationRules
        ? tenantOrEntity
        : {
